...
function UpdateTemario({ show, handleClose, idTemario }) {
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSend.append('id', idTemario);
    formDataToSend.append('idGrupo', id);
    ...
    try {
      ...
      console.log('Temario actualizado exitosamente:', data);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg overflow-hidden shadow-lg w-11/12 max-w-lg">
        <ModalHeader
          ...
          text="Sube el nuevo archivo PDF"
          image="Icons/upload_pdf.jpeg"
